...
public class AiController {
    ...
    /**
     * Returns a response generated by the LLM using prompt-specific default options.
     * <p>
     * These options apply only to this endpoint and are not reusable across the application.
     * </p>
     *
     * @param prompt the input text sent to the LLM
     * @return the generated response wrapped in a {@link ResponseEntity}
     */
    @GetMapping("/prompt/default/response")
